    ...
    public class GamingCornerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Videogame>().HasData(
                new Videogame { VideogameId = 1, Name = "Rocket League", Description = "Altos carros voladores", Stock = 3, Pegi = 12, Available = true, Price = 15, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co5w0w.webp" },
                new Videogame { VideogameId = 2, Name = "GTA 5", Description = "Gran Robo de Autos", Stock = 7, Pegi = 18, Available = true,  Price = 13, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co1twh.webp" },
                new Videogame { VideogameId = 3, Name = "The Witcher 3", Description = "Aventura épica en un mundo de fantasía", Stock = 5, Pegi = 18, Available = true,  Price = 20, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co2lgo.webp" },
                new Videogame { VideogameId = 4, Name = "Minecraft", Description = "Juego de construcción y aventuras",  Stock = 10, Pegi = 7, Available = true,  Price = 25, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co2b4k.webp" },
                new Videogame { VideogameId = 5, Name = "Fortnite", Description = "Juego de supervivencia y construcción",  Stock = 8, Pegi = 12, Available = true,  Price = 0, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co2ekt.webp" },
                new Videogame { VideogameId = 6, Name = "Overwatch", Description = "Juego de disparos en equipo",  Stock = 6, Pegi = 12, Available = true, Price = 30, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co7v86.webp" },
                new Videogame { VideogameId = 7, Name = "FIFA 21", Description = "Simulación de fútbol",  Stock = 12, Pegi = 3, Available = true,  Price = 50, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co3wm2.webp" },
                new Videogame { VideogameId = 8, Name = "Cyberpunk 2077", Description = "Aventura en un mundo futurista",  Stock = 4, Pegi = 18, Available = true,  Price = 60, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co64re.webp" },
                new Videogame { VideogameId = 9, Name = "Red Dead Redemption 2", Description = "Aventura en el Viejo Oeste",  Stock = 9, Pegi = 18, Available = true, Price = 40, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co1q1f.webp" },
                new Videogame { VideogameId = 10, Name = "Assassin's Creed Valhalla", Description = "Aventura de vikingos",  Stock = 7, Pegi = 18, Available = true,  Price = 55, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co1rrw.webp" },
                new Videogame { VideogameId = 11, Name = "Call of Duty: Modern Warfare", Description = "Juego de disparos en primera persona",  Stock = 11, Pegi = 18, Available = true,  Price = 50, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co1rsg.webp" },
                new Videogame { VideogameId = 12, Name = "Horizon Zero Dawn", Description = "Aventura en un mundo postapocalíptico",  Stock = 5, Pegi = 16, Available = true,  Price = 35, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co2una.webp" },
                new Videogame { VideogameId = 13, Name = "Stardew Valley", Description = "Simulación de granja",  Stock = 8, Pegi = 7, Available = true,  Price = 20, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/xrpmydnu9rpxvxfjkiu7.webp" },
                new Videogame { VideogameId = 14, Name = "Among Us", Description = "Juego de deducción social",  Stock = 15, Pegi = 10, Available = true,  Price = 5, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_big/co6kqt.webp" },
                new Videogame { VideogameId = 15, Name = "The Legend of Zelda: Breath of the Wild", Description = "Aventura en el mundo de Hyrule",  Stock = 6, Pegi = 12, Available = true,  Price = 60, ImageURL = "https://images.igdb.com/igdb/image/upload/t_cover_small/co4n26.png" }   
            );
